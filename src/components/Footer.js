...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-brand-ink pt-16 lg:pt-24 pb-8 border-t border-brand-ink/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col">
            <Link href="/" className="inline-block mb-6">
              <span className="text-3xl font-serif text-brand-base block">Whitely</span>
              <span className="text-xs uppercase tracking-[0.2em] font-medium text-brand-muted font-sans block mt-1">Beauty</span>
            </Link>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <ul className="space-y-3 font-sans">
              <li><Link href="/terms" className="text-sm text-brand-muted hover:text-brand-base transition-colors">Terms & Conditions</Link></li>
              <li><Link href="/shipping" className="text-sm text-brand-muted hover:text-brand-base transition-colors">Shipping Policy</Link></li>
              <li><Link href="/privacy" className="text-sm text-brand-muted hover:text-brand-base transition-colors">Privacy Policy</Link></li>
              <li><Link href="/cancellation" className="text-sm text-brand-muted hover:text-brand-base transition-colors">Refund Policy</Link></li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <div className="flex items-center gap-3 mb-8">
              {/* Facebook */}
              <a href="https://www.facebook.com/share/181UEASokN/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-sm bg-brand-base/5 flex items-center justify-center text-brand-base hover:bg-brand-deep hover:text-brand-base transition-all duration-300 group">
              ...
              {/* Instagram */}
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-sm bg-brand-base/5 flex items-center justify-center text-brand-base hover:bg-brand-deep hover:text-brand-base transition-all duration-300 group">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@whitelybeauty?si=IeTY0_8lf6nfdntG" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-sm bg-brand-base/5 flex items-center justify-center text-brand-base hover:bg-brand-deep hover:text-brand-base transition-all duration-300 group">
        ...
        {/* Bottom Bar */}
        <motion.div 
          className="pt-8 border-t border-brand-base/10 flex flex-col md:flex-row justify-between items-center gap-4"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="flex gap-6 text-sm text-brand-muted font-sans">
            <Link href="/privacy" className="hover:text-brand-base transition-colors">Privacy</Link>
            <Link href="/terms" className="hover:text-brand-base transition-colors">Terms</Link>
          </div>
        </motion.div>
      </div>
    </footer>
